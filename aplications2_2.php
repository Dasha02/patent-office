...

{
    ...
    <div class="toph" align="center">
      <a align="center">Список задач по заявкам на проверку значимости</a>
    </div>
    _begin;
    ...
    try
    {
      ...
      WHERE (af.status_id='2' AND (af.user_expert_znak_id=$uid OR af.user_expert_znak_id='1'))";
    ...
    if ($result1->fetch())
    {
      ...
      while ($row1 = $result1->fetch())
      {
          ...
          echo "<form action='aplications2_2_1.php' method='post'>
                <input type='hidden' name='begin_znach' value='true'>";
          echo "<button type='submit'style=\"width:auto;\">Начать проверку значимости</button>";
      ...
      {
        echo '<p align="center">Список задач на проверку заявок на предмет значимости пуст!</p>';
      }        
    ...
    <p>  </p>    
    <div class="toph" align="center">
      <a align="center">Список задач по заявкам на проверку плагиата</a>
    </div>
    ...
    try
    {
      ...
      JOIN 
        status_ap s ON af.status_id = s.status_id
      WHERE (af.status_id='4' AND (af.user_expert_plag_id=$uid OR af.user_expert_plag_id='1'))";
    ...
    if ($result2->fetch())
    {
      ...
      while ($row1 = $result2->fetch())
      {
          ...
          echo "<form action='aplications2_2_2.php' method='post'>
                <input type='hidden' name='begin_plagiat' value='true'>";
          echo "<button type='submit'style=\"width:auto;\">Начать проверку палагиат</button>";
          echo "<input type='hidden' name='ap_id' value='$aplication_id'>
                <input type='hidden' name='zanyato' value='$uid'>
                <input type='hidden' name='aplication_id' value='$aplication_id'>
                <input type='hidden' name='date_registration' value='$date_registration'>
    ...
    {
      echo '<p align="center">Список задач на проверку заявок на предмет плагиата пуст!</p>';
    }
